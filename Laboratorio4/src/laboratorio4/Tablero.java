...
public class Tablero {
    ...
    public void llenarTablero() throws FueraDelTablero {
        for (int i = 0; i < tablero.length; i++) {
            for (int j = 0; j < tablero[i].length; j++) {
                if (i == 0 || i == 1) {
                    ...
                    if (i == 1 && (j == 0 || j == 3 || j == 6 || j == 9)) {
                        tablero[i][j] = new Duende(jugador2.color, null, i, j);
                    }
                }
                if (i == 8 || i == 9) {
                    ...
                    if (i == 8 && (j == 0 || j == 3 || j == 6 || j == 9)) {
                        tablero[i][j] = new Duende(jugador1.color, null, i, j);
                    }
                }
            }
        }
